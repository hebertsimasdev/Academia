...
<body>
    <div class="container">
        <h1 class="text-center">PROJETO ALUNO</h1>
            ...
            <tbody>
                <?php foreach ($lista as $membro): ?>
                    <tr>
                        ...
                        <td><?php echo $membro['plano']; ?></td>

                        <td class="links">
                            <a href="editar.php?id=<?php echo $membro['id']; ?>" class="btn btn-sm btn-primary"><i class="fa fa-pencil"></i> Editar</a>
                            <a href="excluir.php?id=<?php echo $membro['id']; ?>" class="btn btn-sm btn-danger"><i class="fa fa-trash"></i> Excluir</a>
        ...
        <div class="text-center">
            <a href="cadastrar.php" button type="button" class="btn btn-danger">CADASTRO ON</a>
